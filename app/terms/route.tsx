  ...
  return (
    <div className="terms-container">
      <section>
        ...
        <p>
          These Advertiser Terms and Conditions ("Advertiser Terms") govern your
          participation in our advertising program. By applying to advertise our
          product, you acknowledge that you have read, understood, and agree to be
        ...
        <p>
          ...
          <br />
          1. Advertisers must have a minimum of <strong>1,000 followers or subscribers</strong>.
          <br />
        ...
        <p>
          <strong>Advertising Requirements</strong>
          <br />
          1. Each promotional video must achieve a minimum of <strong>3,000 views</strong>.
          <br />
          2. Channels must consistently average <strong>1,000+ views</strong> per video.
          <br />
      ...
      <section>
        <h1>Reseller Terms and Conditions</h1>
